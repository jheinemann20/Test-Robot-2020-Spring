...
public class LiftTopCom extends CommandBase {

  LifterSub liftersub;
  PIDController liftPid;

  /**
   * Creates a new LiftTopCom.
   */
  public LiftTopCom(LifterSub lifterSub) {
  ...
  @Override
  public void execute() {
    liftersub.lift(liftPid.calculate(liftersub.getEncoder(1), 9900));
  }
